  ...
  <div>
    <div class="video-item"
      ...
      <div class="videoInfo pd23">
        <img ref="videoImg"
             :src="item.data.coverUrl + '?param=360y170'"
             alt />
        <circle-loading type="absolute"
                        width="6.7rem"
                        height="3.8rem"
                        class="none"
                        ref="load"></circle-loading>
        <div class="play-video"
             ref="playVideo"
             @touchstart="hideFnBtn(index)">
          <video @canplay="startPlay(index)"
        ...
        <span class="center-bofang">
          <i class="video videobofang1"
             @click="playVideo(index, item.data.vid)"></i>
        </span>
        <span class="go-count">
      ...
      <div class="bottom border-top pd23">
        <div class="creator">
          <div class="img-info">
            <img :src="item.data.creator.avatarUrl + '?param=50y50'"
                 alt />
          </div>
