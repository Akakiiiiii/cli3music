<template>
  <div class="wrapper pd23">
    ...
    <div v-show="!load">
      <public-con title="创作|翻唱"
                  :data="createData.slice(0,4)"></public-con>
      <public-img-wrap title="有声书"
                       :data="soundBookData.slice(0,3)"></public-img-wrap>
      <public-con title="情感调频"
                  :data="emotionData.slice(0,4)"></public-con>
      <public-img-wrap title="广播剧"
                       :data="broadcastingData.slice(0,3)"></public-img-wrap>
      <public-con title="音乐故事"
                  :data="musicData.slice(0,4)"></public-con>
      <public-img-wrap title="娱乐|影视"
                       :data="entertainmentData.slice(0,3)"></public-img-wrap>
      <public-con title="3D|电子"
                  :data="electronicData.slice(0,4)"></public-con>
      <public-img-wrap title="美文读物"
                       :data="mevinData.slice(0,3)"></public-img-wrap>
      <public-con title="二次元"
                  :data="secondaryData.slice(0,4)"></public-con>
      <public-img-wrap title="脱口秀"
                       :data="talkData.slice(0,3)"></public-img-wrap>
      <public-img-wrap title="知识技能"
                       :data="knowledgeData.slice(0,3)"></public-img-wrap>
      <public-img-wrap title="商业财经"
                       :data="businessData.slice(0,3)"></public-img-wrap>
      <public-img-wrap title="人文历史"
                       :data="historyData.slice(0,3)"></public-img-wrap>
      <public-img-wrap title="外文世界"
                       :data="englishData.slice(0,3)"></public-img-wrap>
      <public-img-wrap title="亲子宝贝"
                       :data="babyData.slice(0,3)"></public-img-wrap>
      <public-img-wrap title="相声曲艺"
                       :data="crosstalkData.slice(0,3)"></public-img-wrap>
      <public-img-wrap title="旅途|城市"
                       :data="journeyData.slice(0,3)"></public-img-wrap>
      <public-class title="热门分类"
                    :data="hotClass"></public-class>
      <public-class title="更多分类"
                    :data="moreClass"></public-class>
    </div>
